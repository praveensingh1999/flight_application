...
function validateCreateRequest(req,res,next){
    ...
    if(!req.body.boardingGates){
        ErrorResponse.message='Something went wrong while creating flight';
        ErrorResponse.error = new AppError (['boardingGates not found  in the incoming request in the correct form'],StatusCodes.BAD_REQUEST);
...
function validateUpdateSeatsRequest(req, res, next){
    ...
    if(!req.body.seats) {
        ErrorResponse.message = 'Something went wrong while updating flight flight';
        ErrorResponse.error = new AppError(['seat  not found in the incoming request in the correct form'], StatusCodes.BAD_REQUEST);
        return res
                .status(StatusCodes.BAD_REQUEST)
                .json(ErrorResponse);
    }
